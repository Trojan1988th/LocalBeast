...
Requires: KNOWLEDGE_DATABASE_URL in .env (e.g. postgresql://postgres:password@localhost:5432/agent-knowledge)
"""
...
def main():
    ...
    db_name = path_parts[0] if path_parts else "agent-knowledge"
